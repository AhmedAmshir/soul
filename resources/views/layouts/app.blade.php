...
<head>
    ...
    fbq('init', '1839101320071086');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1839101320071086&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
        ...
        <div class="container">
            ...
            <div class="footer-bottom">
                <div class="footer-social">
                    <a href="https://www.facebook.com/share/1EzWieJrfR/?mibextid=wwXIfr" target="_blank" class="social-link">
                        <svg class="social-icon" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/souloriginegy?igsh=MW5xaGtyaDZjOWs3Zw==" target="_blank" class="social-link">
                        <svg class="social-icon" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div class="footer-copyright">
                    <p>&copy; {{ date('Y') }} Soul. All rights reserved. | Designed with ❤️ for your aromatic wellness</p>
                </div>
            </div>
        </div>
    </footer>
