    ...
    <div id="clearCartModal" class="modal-overlay" style="display: none;">
        <div class="modal-container">
            <div class="modal-content">
                ...
                <p class="modal-message">Are you sure you want to remove all items from your cart?</p>
                <div class="modal-actions">
                    <button type="button" class="btn btn-outline" onclick="closeClearCartModal()">
                        Cancel
                    </button>
                    <button type="button" class="btn btn-primary" onclick="confirmClearCart()">
                        Clear Cart
                    </button>
                </div>
            </div>
