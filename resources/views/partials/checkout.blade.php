                        ...
                        <div class="checkout-form-card">
                            ...
                            <form id="checkoutForm" action="{{ route('order.place') }}" method="POST">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="form-group">
                                        <label for="apartment_suite" class="form-label">Apartment, Suite, etc. (Optional)</label>
                    ...
                    <div class="checkout-summary-section">
                                ...
                                <div class="order-item">
                                    <div class="order-item-image">
                                        ...
                                        <div class="order-item-details">
                                            ...
                                            <div class="item-price">{{ number_format($item['price'] * $item['quantity'], 0) }} LE</div>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="order-totals">
                            <div class="total-row">
                                    ...
                                    <span class="total-value" id="orderSubtotal">{{ number_format($totalPrice, 0) }} LE</span>
                            </div>
                                
                            <div class="total-row" id="discountRow" style="display: none;">
                                    <span class="total-label">Discount</span>
                                    <span class="total-value" id="discountAmount" style="color: #10b981;">- 0 LE</span>
                            </div>
                            ...
                            <div class="total-row">
                                ...
                                <div class="total-row total-final">
                                    ...
                                    <span class="total-value total-amount" id="orderTotal">{{ number_format($totalPrice + config('app.shipping_fee'), 0) }} LE</span>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateOrderSummary(discount) {
                ...
                if (discountAmount > 0) {
                    $('#discountRow').show();
                    $('#discountAmount').text('-' + Math.round(discountAmount).toLocaleString() + ' LE');
                } else {
                    $('#discountRow').hide();
                }

                // Update total
                $('#orderTotal').text(Math.round(total).toLocaleString() + ' LE');
            }
